...
Intro
-----
Triskelpremium (TKP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Triskelpremium utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run triskelpremium-qt.exe.

Triskelpremium Core is the original Triskelpremium client and it builds the backbone of the network.
However, it downloads and stores the entire history of Triskelpremium transactions;

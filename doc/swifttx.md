...
This mechanism has been integrated into Bitcore-Node-Triskelpremium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/triskelpremium/insight-api-triskelpremium#web-socket-api](https://github.com/triskelpremium/insight-api-triskelpremium#web-socket-api)
* API: [https://github.com/triskelpremium/insight-api-triskelpremium#swifttx-transactions](https://github.com/triskelpremium/insight-api-triskelpremium#swifttx-transactions)
...
By default, the Triskelpremium Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Triskelpremium Core daemon:

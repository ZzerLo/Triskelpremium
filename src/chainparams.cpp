...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 2 * 60;  // Triskelpremium: 2 minute blocks during POW (block 1-200)
        ...
        // Triskelpremium addresses start with 'N'
...
public:
    CTestNetParams()
    {
       ...
       // assert(hashGenesisBlock == uint256("0x000008467c3a9c587533dea06ad9380cded3ed32f9742a6c0c1aebc21bf2bc9b"));
        ...
        // Testnet Triskelpremium addresses start with 'g'

...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Triskelpremium server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Triskelpremium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Triskelpremium features */
        {"triskelpremium", "masternode", &masternode, true, true, false},
        {"triskelpremium", "listmasternodes", &listmasternodes, true, true, false},
        {"triskelpremium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"triskelpremium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"triskelpremium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"triskelpremium", "masternodedebug", &masternodedebug, true, true, false},
        {"triskelpremium", "startmasternode", &startmasternode, true, true, false},
        {"triskelpremium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"triskelpremium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"triskelpremium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"triskelpremium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"triskelpremium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"triskelpremium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"triskelpremium", "mnbudget", &mnbudget, true, true, false},
        {"triskelpremium", "preparebudget", &preparebudget, true, true, false},
        {"triskelpremium", "submitbudget", &submitbudget, true, true, false},
        {"triskelpremium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"triskelpremium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"triskelpremium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"triskelpremium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"triskelpremium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"triskelpremium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"triskelpremium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"triskelpremium", "checkbudgets", &checkbudgets, true, true, false},
        {"triskelpremium", "mnsync", &mnsync, true, true, false},
        {"triskelpremium", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> triskelpremium-cli " + methodname + " " + args + "\n";
}

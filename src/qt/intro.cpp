...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Triskelpremium Core"),
     ...
     * override -datadir in the triskelpremium.conf file in the default data directory
     * (to be consistent with triskelpremiumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

...
/** Utility functions used by the Triskelpremium Qt UI.
 */
namespace GUIUtil
{
...
// Render TKP addresses in monospace font
...
// Parse "triskelpremium:" URI into recipient object, return true on successful parsing

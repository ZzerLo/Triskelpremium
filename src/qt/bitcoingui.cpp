                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Triskelpremium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TKP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and triskelpremium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Triskelpremium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Triskelpremium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Triskelpremium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TKP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TKP addresses"));
    ...
    openAction->setStatusTip(tr("Open a triskelpremium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Triskelpremium Core help message to get a list with possible Triskelpremium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Triskelpremium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Triskelpremium network", "", count));
}
...
{
    QString strTitle = tr("Triskelpremium Core"); // default title
    ...
    // Append title to "Triskelpremium - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

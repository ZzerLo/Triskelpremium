...
#if defined(NDEBUG)
#error "Triskelpremium cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in utkp) are considered zero fee (for relaying and mining)
...
{
    RenameThread("triskelpremium-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // TKP: We use certain sporks during IBD, so check to see if they are

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Triskelpremium Core triskelpremium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  triskelpremium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded triskelpremium transaction") + "\n" +
                               "  triskelpremium-tx [options] -create [commands]   " + _("Create hex-encoded triskelpremium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded triskelpremium transaction

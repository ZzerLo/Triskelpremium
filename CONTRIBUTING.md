Contributing to Triskelpremium Core
==================================

The Triskelpremium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Triskelpremium Core project, and is not to be
confused with overall Triskelpremium Network Protocol consensus changes.

Whether a pull request is merged into Triskelpremium Core rests with the project merge
...
Patches that change Triskelpremium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Triskelpremium consensus, it must have been
...
The project leader is the release manager for each Triskelpremium Core release.
